/**
 * Aggressive Mode Hub V2 — Market Quality Score
 * Same 4 sub-component formula as FLOW (different config weights imported)
 */

import type { HubInput, MarketQualityResult } from "./types.ts";
