...
/* ── TP/SL visual ─────────────────────────────────────── */
function TpSlVisual({ tpSl, direction }: { tpSl: NonNullable<HubSnapshotItem["payload"]["tpSl"]>; direction: string }) {
  const isLong = direction === "LONG";
  const levels = [
    { label: `SL (${tpSl.slMarginPct}%)`, price: tpSl.sl, color: "#d46a6a", alloc: null },
    { label: "Entry", price: (tpSl.entryZone[0] + tpSl.entryZone[1]) / 2, color: "#F5C542", alloc: null },
