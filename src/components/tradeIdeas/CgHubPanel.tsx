...
/* ── TP/SL visual ─────────────────────────────────────── */
function TpSlVisual({ tpSl, direction: _direction }: { tpSl: NonNullable<CgSnapshotItem["payload"]["tpSl"]>; direction: string }) {
  ...
  const levels = [
    ...
    { label: "Entry", price: entryMid, color: "#c4a0e8", alloc: null },
