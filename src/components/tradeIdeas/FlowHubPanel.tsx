...
/* ── TP/SL visual ─────────────────────────────────────── */
function TpSlVisual({ tpSl, direction: _direction }: { tpSl: NonNullable<FlowSnapshotItem["payload"]["tpSl"]>; direction: string }) {
  ...
  const levels = [
    ...
    { label: "Entry", price: entryMid, color: "#5ec2f5", alloc: null },
