...
const plans = [
  {
    label: "PLAN A",
    title: "EB-2 NIW",
    subtitle: "Primary pathway",
    fit: "85%",
    complexity: "Medium",
    timeline: "12-18 months",
    reason: "Strong profile fit with Master's degree and 10+ years experience. No employer sponsor needed — self-petition.",
  ...
  },
  {
    label: "PLAN B",
    title: "H-1B",
    subtitle: "Fallback strategy",
    fit: "62%",
    complexity: "Medium",
    timeline: "6-12 months",
    reason: "Requires employer sponsorship and annual lottery selection. Strong backup if EB-2 timeline is too long.",
  ...
  },
  {
    label: "PLAN C",
    title: "EB-1A",
    subtitle: "Long-horizon option",
    fit: "41%",
    complexity: "High",
    timeline: "6-12 months",
    reason: "Requires extraordinary ability evidence. Build publications and awards over time to strengthen eligibility.",
      ...
      <div className="relative mx-auto max-w-content px-6 md:px-10">
        <Animate animation="fade-up" duration={700}>
          <div className="mx-auto max-w-3xl text-center mb-14">
            ...
            <h2 className="mt-3 text-4xl font-semibold tracking-tight text-white md:text-5xl">
              Three strategies, one clear direction.
            </h2>
            <p className="mt-4 text-lg leading-relaxed text-white/50">
              Our AI analyzes your profile against 47 visa categories and generates personalized
              Plan A, B, and C with confidence scores and reasoning.
            </p>
          </div>
        </Animate>
            ...
            >
              ...
              <div className="p-7">
                <div className="flex items-center justify-between">
                  <span className={`inline-flex rounded-full bg-gradient-to-r ${plan.gradient} px-3 py-1 text-xs font-semibold text-white`}>
                    {plan.label}
                  </span>
                ...
                <div className="mt-5">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-white/60">Suitability</span>
        ...
        <Animate animation="fade-up" delay={400} duration={600}>
          <p className="mt-10 text-center text-sm text-white/30">
            Powered by OpenAI gpt-4o-mini &middot; Confidence scoring (0-100) &middot; Knowledge-grounded responses &middot; 47 visa categories
          </p>
        </Animate>
      </div>
    </section>
