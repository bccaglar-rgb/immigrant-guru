...
export function CaseForm({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!validation.success) {
      ...
      setFormError("Review the highlighted case fields before saving.");
      return;
    }
  ...
  const resolvedSubmitLabel =
    submitLabel ??
    (mode === "create" ? "Create strategy case" : "Save case changes");
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h3 className="mt-3 text-xl font-semibold tracking-tight text-ink">
            {mode === "create"
              ? "Define a migration pathway to evaluate"
              : "Update the case strategy record"}
          </h3>
          <p className="mt-3 max-w-3xl text-sm leading-7 text-muted">
            Capture the destination, program, current stage, and risk signals that
            anchor strategy generation, scoring, and document workflows.
          </p>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <Input
                ...
                placeholder="U.S. employment-based migration plan"
              ...
              <Input
                ...
                label="Target pathway or program"
                onChange={(event) =>
              ...
              <Input
                ...
                helperText="Example: eligibility_review, document_collection, filing_ready"
                label="Current stage"
                onChange={(event) =>
          ...
          <div>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <Input
                ...
                helperText="Optional score snapshot if you want to retain a manual benchmark."
                inputMode="decimal"
                label="Latest score"
                onChange={(event) =>
              ...
              <Input
                ...
                helperText="Higher values should indicate higher execution or eligibility risk."
                inputMode="decimal"
                label="Risk score"
                onChange={(event) =>
              ...
              <div className="md:col-span-2">
                <Textarea
                  ...
                  helperText="Keep notes focused on blockers, evidence gaps, and next actions."
                  label="Strategy notes"
                  onChange={(event) => handleChange("notes", event.target.value)}
                  placeholder="Collect recommendation letters and evidence of impact."
