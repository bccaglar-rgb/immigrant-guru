...
const CSP = [
  ...
  "script-src 'self' 'unsafe-inline' https://js.stripe.com https://www.googletagmanager.com https://www.google-analytics.com https://admin.caglarlabs.com https://accounts.google.com https://appleid.cdn-apple.com",
  ...
  `connect-src 'self' ${process.env.NEXT_PUBLIC_API_URL ?? ""} https://www.google-analytics.com https://analytics.google.com https://api.stripe.com https://admin.caglarlabs.com https://accounts.google.com https://appleid.apple.com wss:`,
  // Stripe payment iframe + Google/Apple sign-in popup iframes
